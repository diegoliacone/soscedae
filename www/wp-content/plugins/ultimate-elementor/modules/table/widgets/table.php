		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'description'  => __( 'Conrtols the number of entries in a table.', 'uael' ),
					'type'         => Controls_Manager::SWITCHER,
					'label_on'     => __( 'Yes', 'uael' ),
					'label_off'    => __( 'No', 'uael' ),
					'return_value' => 'yes',
			...
			// Table heading border Row/Cell Note.
			$this->add_control(
				'responsive_control_note',
				[
					'type'      => Controls_Manager::RAW_HTML,
					'raw'       => sprintf( '<p style="font-size: 12px;font-style: italic;line-height: 1.4;color: #a4afb7;">%s</p>', __( 'Note: In responsive design, table will be stacked. cells of each row will be displayed one after another.', 'uael' ) ),
					'separator' => 'before',
				]
			);
	...
	protected function register_header_style_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} th.uael-table-col,  {{WRAPPER}}.uael-table--responsive td:before, {{WRAPPER}}.uael-table--responsive th:before',
			]
		);
			...
			$this->start_controls_tab( 'tab_header_colors_row', [ 'label' => __( 'Default', 'uael' ) ] );
				...
				$this->add_group_control(
					...
					[
						...
						'selector'       => '{{WRAPPER}} thead tr.uael-table-row, {{WRAPPER}} tbody .uael-table-row th, {{WRAPPER}}.uael-table--responsive .no-column-rules tr, {{WRAPPER}}.uael-table--responsive .no-column-rules tr',
						'condition'      => [
				...
				$this->add_control(
					...
					[
						...
						'selectors' => [
							...
							'{{WRAPPER}}.uael-table--responsive td:hover::before' => 'color: {{VALUE}};',
							'{{WRAPPER}}.uael-table--responsive th:hover::before' => 'color: {{VALUE}};',
						],
					]
				);

...
use UltimateElementor\Modules\Timeline\Widgets\UAEL_Posts_Helper;
		...
		if ( parent::is_internal_links() ) {
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf( __( '%1$s Getting started video » %2$s', 'uael' ), '<a href="https://www.youtube.com/watch?v=-FErpbu2F58" target="_blank" rel="noopener">', '</a>' ),
					'content_classes' => 'uael-editor-doc',
				]
			);
		...
		$this->start_controls_tab( 'tab_card_default', [ 'label' => __( 'DEFAULT', 'uael' ) ] );
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .uael-timeline-shadow-yes .uael-events-inner-new' => 'filter: drop-shadow(0px 1px {{timeline_cards_box_shadow_blur.SIZE}}px {{VALUE}});',
						'{{WRAPPER}} .uael-timeline-shadow-yes .uael-events-inner-new' => '-webkit-filter: drop-shadow(0px 1px {{timeline_cards_box_shadow_blur.SIZE}}px {{VALUE}});',
					],
					'condition' => [

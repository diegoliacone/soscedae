...
class Video_Gallery extends Common_Widget {
			...
			$this->add_control(
				...
				[
					...
					'default'     => [
						[
							'type'              => 'youtube',
							'video_url'         => 'https://www.youtube.com/watch?v=HJRzUQMhJMQ',
						...
						[
							'type'              => 'vimeo',
							'video_url'         => 'https://vimeo.com/274860274',
		...
		$this->start_controls_section(
			...
			$this->add_group_control(
				...
				[
					'name'     => 'all_typography',
					'scheme'   => Scheme_Typography::TYPOGRAPHY_4,
					'selector' => '{{WRAPPER}} .uael-video__gallery-filter',
				]
			);
			$this->add_responsive_control(
				'cat_filter_padding',
			...
			$this->start_controls_tab(
				...
				$this->add_control(
					...
					[
						...
						'selectors' => [
							'{{WRAPPER}} .uael-video__gallery-filter' => 'color: {{VALUE}};',
						],
					]
				);
				...
				$this->add_control(
					...
					[
						...
						'type'      => Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .uael-video__gallery-filter' => 'background-color: {{VALUE}};',
						],
					]
				);
	...
	public function get_play_button() {
		...
		<?php } else { ?>
			<img class="uael-vg__dummy-image" />
			<img class="uael-vg__play-image <?php echo 'elementor-animation-' . $settings['hover_animation_img']; ?>" src="<?php echo $settings['play_img']['url']; ?>" />

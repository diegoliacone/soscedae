...
class Image_Gallery extends Common_Widget {
		...
		$this->start_controls_section(
			...
			$this->add_group_control(
				...
				[
					...
					'selector'  => '{{WRAPPER}} .uael-grid-img-caption',
					'condition' => [
						'gallery_caption!' => '',
					],
				]
			...
			$this->add_control(
				...
				[
					...
					'default'   => '',
					'selectors' => [
						'{{WRAPPER}} .uael-grid-img-caption' => 'color: {{VALUE}};',
					],
					'condition' => [
						'gallery_caption!' => '',
					],
	...
	protected function render_image_overlay() {
		...
		if ( 'icon' === $settings['overlay_image_type'] ) {
			...
			if ( ! empty( $settings['overlay_image_hover']['url'] ) ) {
				$output .= '<img class="uael-overlay-img" src="' . $settings['overlay_image_hover']['url'] . '">';
			}
		}
	...
	protected function render_image_caption( $image ) {
		...
		$output          = '<figcaption class="uael-grid-img-content">';
			$output     .= '<' . $settings['caption_tag'] . ' class="uael-grid-img-caption">';

...
class Skin_Event_Countdown extends Elementor_Skin_Base {
	...
	protected function render_text() {
		...
		$event_button_icon_class['class']    = ['bdt-event-button-icon', 'elementor-button-icon', 'elementor-align-icon-' . $this->get_instance_value('event_button_icon_align')];
		...
		<span <?php echo \element_pack_helper::attrs($event_button_wrapper); ?>>
			<?php if ( ! empty( $event_button_icon ) ) : ?>
			<span <?php echo \element_pack_helper::attrs($event_button_icon_class); ?>>

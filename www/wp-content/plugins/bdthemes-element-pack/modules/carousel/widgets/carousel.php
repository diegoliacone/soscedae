	...
	private function register_query_section_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-carousel .bdt-carousel-layout-vertical' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				],
				'condition' => [
					'layout' => 'vertical'
				],
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'condition' => [
		        	'item_hover_shadow_switcher' => 'yes',
		        ]
		    ]
		);
